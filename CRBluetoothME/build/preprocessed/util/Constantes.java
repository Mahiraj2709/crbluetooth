...
public interface Constantes {
    ...
    public final String TXT_SELECIONE_OPCAO = "Selecione uma opção";
    
    public final String TXT_CONECTADO = "Conectado a:";
    public final String TXT_DESCONECTADO = "Desconectado de:";
    public final String ERRO_CONEXAO = "Erro ao conectar a:";
    public final String ERRO_DESCONECTAR = "Erro ao desconectar.";
